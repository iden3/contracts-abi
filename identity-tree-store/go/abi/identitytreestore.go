...
//
// Solidity: function getNode(uint256 hash) view returns(uint256[])
func (_IdentityTreeStore *IdentityTreeStoreCaller) GetNode(opts *bind.CallOpts, hash *big.Int) ([]*big.Int, error) {
	var out []interface{}
	err := _IdentityTreeStore.contract.Call(opts, &out, "getNode", hash)
...
//
// Solidity: function getNode(uint256 hash) view returns(uint256[])
func (_IdentityTreeStore *IdentityTreeStoreSession) GetNode(hash *big.Int) ([]*big.Int, error) {
	return _IdentityTreeStore.Contract.GetNode(&_IdentityTreeStore.CallOpts, hash)
}

// GetNode is a free data retrieval call binding the contract method 0x4f0f4aa9.
//
// Solidity: function getNode(uint256 hash) view returns(uint256[])
func (_IdentityTreeStore *IdentityTreeStoreCallerSession) GetNode(hash *big.Int) ([]*big.Int, error) {
	return _IdentityTreeStore.Contract.GetNode(&_IdentityTreeStore.CallOpts, hash)
}
...
func (_IdentityTreeStore *IdentityTreeStoreTransactor) SaveNodes(opts *bind.TransactOpts, nodes [][]*big.Int) (*types.Transaction, error) {
	return _IdentityTreeStore.contract.Transact(opts, "saveNodes", nodes)
}

// SaveNodes is a paid mutator transaction binding the contract method 0x879957f7.
//
// Solidity: function saveNodes(uint256[][] nodes) returns()
func (_IdentityTreeStore *IdentityTreeStoreSession) SaveNodes(nodes [][]*big.Int) (*types.Transaction, error) {
	return _IdentityTreeStore.Contract.SaveNodes(&_IdentityTreeStore.TransactOpts, nodes)
}

// SaveNodes is a paid mutator transaction binding the contract method 0x879957f7.
//
// Solidity: function saveNodes(uint256[][] nodes) returns()
func (_IdentityTreeStore *IdentityTreeStoreTransactorSession) SaveNodes(nodes [][]*big.Int) (*types.Transaction, error) {
	return _IdentityTreeStore.Contract.SaveNodes(&_IdentityTreeStore.TransactOpts, nodes)
}
