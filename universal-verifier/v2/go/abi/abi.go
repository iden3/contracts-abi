...
//
// Solidity: event RequestSet(uint256 indexed requestId, address indexed creator, string metadata, address validator, bytes params)
func (_UniversalVerifier *UniversalVerifierFilterer) FilterRequestSet(opts *bind.FilterOpts, requestId []*big.Int, creator []common.Address) (*UniversalVerifierRequestSetIterator, error) {
	...
	logs, sub, err := _UniversalVerifier.contract.FilterLogs(opts, "RequestSet", requestIdRule, creatorRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event RequestSet(uint256 indexed requestId, address indexed creator, string metadata, address validator, bytes params)
func (_UniversalVerifier *UniversalVerifierFilterer) WatchRequestSet(opts *bind.WatchOpts, sink chan<- *UniversalVerifierRequestSet, requestId []*big.Int, creator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _UniversalVerifier.contract.WatchLogs(opts, "RequestSet", requestIdRule, creatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
//
// Solidity: event RequestUpdate(uint256 indexed requestId, address indexed creator, string metadata, address validator, bytes params)
func (_UniversalVerifier *UniversalVerifierFilterer) FilterRequestUpdate(opts *bind.FilterOpts, requestId []*big.Int, creator []common.Address) (*UniversalVerifierRequestUpdateIterator, error) {
	...
	logs, sub, err := _UniversalVerifier.contract.FilterLogs(opts, "RequestUpdate", requestIdRule, creatorRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event RequestUpdate(uint256 indexed requestId, address indexed creator, string metadata, address validator, bytes params)
func (_UniversalVerifier *UniversalVerifierFilterer) WatchRequestUpdate(opts *bind.WatchOpts, sink chan<- *UniversalVerifierRequestUpdate, requestId []*big.Int, creator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _UniversalVerifier.contract.WatchLogs(opts, "RequestUpdate", requestIdRule, creatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
